import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as i,d as s,a,f as d}from"./app-c1884dba.js";const l={},v=a("p",null,"En este post vamos a ver una de las opciones de sincronización mas utilizadas de momento, haremos uso del CDC de nuestra base de datos transaccional MySQL para publicar cada una de sus entradas en nuestro stack de Kafka.",-1),r=d(`<h2 id="introduccion" tabindex="-1"><a class="header-anchor" href="#introduccion" aria-hidden="true">#</a> Introduccion</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>version: &#39;3&#39;
services:
  mysql:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3);function c(u,o){return e(),i("div",null,[v,s(" more "),r])}const b=n(l,[["render",c],["__file","playground.html.vue"]]);export{b as default};
