...
- En un sistema de gestión de bases de datos (DBMS) orientado a filas, los datos se almacenan en filas, con todos los valores relacionados con una fila almacenados físicamente uno al lado del otro.
![row-oriented.gif](/assets/images/row-oriented.gif)
- En un sistema de gestión de bases de datos orientado a columnas, los datos se almacenan en columnas, con valores de las mismas columnas almacenados juntos.
...
### Representación gráfica de la poda por indice
![indexes.png](/assets/images/indexes.png)
