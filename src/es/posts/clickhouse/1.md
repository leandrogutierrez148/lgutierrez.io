...
Enfrentarse a un proyecto de ingenieria de datos puede resultar abrumador, sobre todo cuando uno quiere dar sus primeros pasos en este vasto mundo. El horizonte de opciones parece volverse infinito con el avance de nuevas tecnologías, arquitecturas, frameworks y hasta paradigmas.

A diario vemos crecer el la cantidad de información que almacenamos, traficamos y procesamos. No siempre es posible ver a tiempo el crecimiento exponencial en la producción de nueva información, ésto puede deverse a una inercia evolutiva natural en terminos de vida de un proyecto de software. Se puede oir "Necesitamos acceder a mas información, mas rápido", pero... ¿lo necesitamos?

Dependiendo el tipo de solución que el software esté ofreciendo tanto su arquitectura como infraestructura pueden haber ido mutando durante el tiempo. En general (no digo siempre) se parte de una base de datos relacional, las cuales suelen ser simples de comprender, montar y manipular; y son quizás el primer punto de contacto que un programador suele tener al toparse con el mundillo de los datos. Vale la pena mencionar que cualquier solución que requiera procesar transacciones usualmente almacenará su información en una Base de datos T relacional, leanse MySQL, MariaDB, SQL Server, Oracle.
...
![sparse-primary-indexes.png](/assets/images/sparse-primary-indexes.png)
![sparse-primary-indexes2.png](/assets/images/sparse-primary-indexes-2.png)
![sparse-primary-indexes3.png](/assets/images/sparse-primary-indexes-3.png)
